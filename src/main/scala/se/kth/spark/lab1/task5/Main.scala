...
object Main {
  def main(args: Array[String]) {
    ...
    val arrayStages = Array(regexTokenizer,arr2Vect,lSlicer,v2d,lShifter,fSlicer,polynomialExpansion,learningAlg)
    ...
    val bestModelSummary = cvModel.bestModel.asInstanceOf[PipelineModel].stages(7).asInstanceOf[LinearRegressionModel]
    ...
    //numIterations: 17 RMSE: 17.186532410898657 r2: 0.3561156908111298
